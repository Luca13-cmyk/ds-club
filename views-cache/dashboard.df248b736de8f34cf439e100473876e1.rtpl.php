<?php if(!class_exists('Rain\Tpl')){exit;}?>
      ...
      <div class="content">
        ...
        <div class="row">
          <div class="container">
            ...
            <!-- <nav aria-label="breadcrumb" role="navigation">
              ...
              <hr>
              <div class="media">
                <img  src="/res/site/assets/img/sprite.png" style="margin-right: 70px;" alt="...">
              
                <div class="media-body">
                    <h5  class="mt-0">Lançamentos</h5>
                    Acompanhe todos os lançamentos de perto.
                </div>
              </div>
              <hr>
          </div>
        ...
        <div id="row-per" class="row">
          ...
          <div class="card-deck">
            <!-- LOOP php -->
              <a data-article_lnk href="">
                  <div  data-article_per class="card" style="max-width: 208px;">
